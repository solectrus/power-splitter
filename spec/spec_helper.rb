...
RSpec.configure do |config|
  ...
  #
  # A file order that happens to work hides what one example leaves behind for
  # the next - which is how a config that defined its sensors on the class went
  # unnoticed. Reproduce a failing order with the seed it printed:
